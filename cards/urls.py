...
urlpatterns = [
    ...
    path('favourites', lambda r: HttpResponseRedirect('favourites/1')),
    path('favourites/<int:page_num>', views.favourites, name='favourites'),
    path('deck/<int:deck_id>', views.detail, name='detail'),
